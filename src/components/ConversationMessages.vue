<template>
  <div class="conversation-messages-ctn">
    <div class="header">
      <div class="user-info">
        <div class="profile">
          <img src="@/assets/bitmaps/image1.png" alt="">
          <div class="online" />
        </div>
        <div class="names">
          <div class="full-name">
    ...
    <div class="message-input-ctn">
      <div class="message-input">
        ...
        <button v-else :class="{'clear-btn': true, 'post-btn': true}">
          Send
        </button>
      </div>
    </div>
